        ...
        <div className="max-w-3xl mx-auto px-4">
          ...
          <div className="rounded-xl p-8 border-white/10 border hover:-translate-y-1 transition-all">
            <p className="text-gray-300 mb-6">
              I’m <strong>Khalid EL Mati</strong>, a passionate Full Stack Web
            ...
            <div className="p-6 rounded-xl border-white/10 border hover:-translate-y-1 transition-all">
              ...
              <ul className="list-disc list-inside text-gray-300 space-y-2">
                <li>
                  ...
                  – École Supérieure de Technologie de Kénitra (2025)
                </li>
                <li>
                <strong>YouCode</strong> (OCP, Simplon & UM6P Partnership) –
                  Project-based learning in Agile, responsive web design, and
                  teamwork. Youssofia(2023)
                </li>
                <li>
                  <strong>
                    Diploma: Specialized Technician in Software Development
                  </strong>{" "}
                  – Al Ahramat School, Laâyoune (2020)
                </li>
              </ul>
            </div>
